...
void setup() {
  ...
  aOPCSerial.addItem("item_bool_random",opc_read, opc_bool, item_bool);
  aOPCSerial.addItem("item_bool_true",opc_read, opc_bool, item_bool);  
  aOPCSerial.addItem("item_bool_false",opc_read, opc_bool, item_bool);    
  
  // byte OPC items
  // http://arduino.cc/en/Reference/Byte
  aOPCSerial.addItem("item_byte_random",opc_write, opc_byte, item_byte);  
  aOPCSerial.addItem("item_byte_asc",opc_read, opc_byte, item_byte_asc); 
  
  // int OPC items
  // http://arduino.cc/en/Reference/Int
  aOPCSerial.addItem("item_int_random",opc_readwrite, opc_int, item_int);  
  
  // float OPC items
  // http://arduino.cc/en/Reference/Float
  aOPCSerial.addItem("item_float_asc",opc_read, opc_float, item_float_asc);
